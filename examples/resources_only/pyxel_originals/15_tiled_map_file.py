...
class App:
    def __init__(self):
        ...
        ryxel.watch_resource('assets/urban_rpg.png')
        #ryxel.watch_resource('assets/urban_rpg.tmx')
        # Load those resources. This will also be called if any of those
        # files is modified.
        self.reload_resources([])

        for i in range(3):
            ryxel.tilemaps[i].load(0,0, "assets/urban_rpg.tmx", i)
    ...
    def reload_resources(self, changed):
        print('Loading tilemap image and tmx')
