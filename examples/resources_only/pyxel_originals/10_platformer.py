...
class App:
    def __init__(self):
        ...
        ryxel.load("assets/platformer.pyxres")
    ...
    def reload_resources(self, _list_of_resources):
        # platformer.pyxres was reloaded, we must re-fix the spawn tiles
        pyxel.images[0].rect(0, 8, 24, 8, TRANSPARENT_COLOR)
        print('spawn tiles fixed')
